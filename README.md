...
| **Local review workbench (RC)** | one author-controlled review from selected files to an explicit new copy | reads only files you choose; never overwrites the source | hash-bound local sessions |
...
The release-candidate workbench is the smallest end-to-end AWT product surface:
